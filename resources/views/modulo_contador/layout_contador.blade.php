    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
                <a class="nav-link" href="reporte_ingresos">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
                <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseComponents" data-parent="#exampleAccordion">
                    ...
                    <span class="nav-link-text">Reportes libros diarios</span>
                </a>
                <ul class="sidenav-second-level collapse" id="collapseComponents">
                    <li>
                        <a href="reporte_ingresos">Reporte Ingresos</a>
                    </li>
                    <li>
                        <a href="reporte_egresos">Reporte Egresos</a>
                    </li>
                    <li>
                        <a href="reporte_inversion">Reporte Inversiones</a>
                    </li>
                    <li>
                        <a href="">Exportar libro diario</a>
                    </li>
                </ul>
            </li>

            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
                <a class="nav-link" href="libro_mayor">
                    <i class="fa fa-fw fa-dashboard"></i>
                    <span class="nav-link-text" >Reporte Libro Mayor</span>
                </a>
            </li>

            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
                <a class="nav-link" href="sumas_resultados">
                    <i class="fa fa-fw fa-dashboard"></i>
                    <span class="nav-link-text" >Reporte Sumas y Resultados</span>
                </a>
            </li>
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
                <a class="nav-link" href="">
                    <i class="fa fa-fw fa-dashboard"></i>
                    <span class="nav-link-text" >Balance General</span>
                </a>
            </li>
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
                <a class="nav-link" href="">
                    <i class="fa fa-fw fa-dashboard"></i>
                    <span class="nav-link-text" >Estado de Resultados</span>
                </a>
            </li>
