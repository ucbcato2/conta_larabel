      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
         ...
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            ...
            <li>
              <a href="listado_usuarios">Listado usuarios</a>
            </li>
          </ul>
        </li>
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            <li>
              <a href="registro_cuenta">Registrar nueva cuenta</a>
            </li>
            <li>
              <a href="listado_cuenta">Listado de cuentas</a>
            </li>
          </ul>
        </li>
      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="datos_entidad">
            <i class="fa fa-fw fa-table"></i>
            <span class="nav-link-text">Datos de la entidad</span>
          </a>
        </li>
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="adicionar_gestion">
            <i class="fa fa-fw fa-table"></i>
            <span class="nav-link-text">Adicionar gestion</span>
          </a>
        </li>
